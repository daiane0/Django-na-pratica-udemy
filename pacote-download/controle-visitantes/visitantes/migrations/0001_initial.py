# Generated by Django 3.0 on 2022-03-05 11:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('horario_autorizado', models.DateTimeField(blank=True, null=True, verbose_name='Horário de autorização e entrada')),
                ...
                ('registrado_por', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='porteiros.Porteiro', verbose_name='Porteiro responsável pelo registroo')),
            ],
            options={
